  ...
  test('one arrow', async () => {
    ...
    expect(onml.parse(svg)).toEqual(
      ['svg', { xmlns: 'http://www.w3.org/2000/svg', width: '275', height: '150' },
        ...
        ['path', { d: 'M 125 75 L 125 75 L 137.5 75 L 150 75', stroke: 'black', 'marker-end': 'url(#>)', fill: 'none' }]
      ])
  })
  ...
  test('two arrows', async () => {
    ...
    expect(onml.parse(svg)).toEqual(
      ['svg', { xmlns: 'http://www.w3.org/2000/svg', width: '275', height: '150' },
        ...
        ['path', { d: 'M 150 91.66666666666666 L 137.5 91.66666666666666 L 125 91.66666666666666 L 125 91.66666666666666', stroke: 'black', 'marker-end': 'url(#>)', fill: 'none' }],
        ['path', { d: 'M 125 58.33333333333333 L 125 58.33333333333333 L 137.5 58.33333333333333 L 150 58.33333333333333', stroke: 'black', 'marker-end': 'url(#>)', fill: 'none' }]
      ])
  })
})
